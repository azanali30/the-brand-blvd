...
const EditProduct = () => {
  ...
  const addVariant = () => {
    ...
    if (!size || !price) {
      setNotification({
        type: "error",
        message: "Please enter size and price.",
      });
  ...
  const handleSubmit = async (
    ...
    if (variants.length === 0) {
      setNotification({
        type: "error",
        message:
          "Please add at least one size variant.",
      });
    ...
    if (invalidVariant) {
      setNotification({
        type: "error",
        message:
          "Please check all variant sizes, prices and stock values.",
      });

      return;
    }

    const normalizedSizes = variants.map(
      (variant) => variant.size.trim().toUpperCase()
    );
    ...
    if (duplicateSizes.length > 0) {
      setNotification({
        type: "error",
        message: `Duplicate size variant: ${duplicateSizes[0]}`,
      });
          ...
          <div className="space-y-5">
            ...
            <section className="bg-white p-6 md:p-8">
              <div className="mb-7">
                ...
                <p className="mt-1 text-xs text-black/40">
                  Each size can have its own price and stock.
                </p>
              </div>
              ...
              {variants.length > 0 && (
                <div className="space-y-3">
                  <div className="hidden grid-cols-[100px_1fr_1fr_auto] gap-3 px-4 sm:grid">
                  ...
                  {variants.map((variant, index) => (
                    <div
                      ...
                      className="grid gap-2 bg-[#f7f7f7] p-3 sm:grid-cols-[100px_1fr_1fr_auto]"
                    >
                      <div>
                        <label className="mb-1 block text-[8px] uppercase tracking-[0.15em] text-black/35 sm:hidden">
                          Size
                        </label>
                        ...
                        <input
                          ...
                          className="w-full bg-white px-3 py-3 text-sm uppercase outline-none"
                        />
                      </div>
                      ...
                      <button
                        ...
                        className="flex h-11 w-full items-center justify-center bg-white text-black/40 transition-colors hover:bg-black hover:text-white sm:h-auto sm:w-11"
                      >
                        <X
                          size={15}
                          strokeWidth={1.5}
              ...
              {/* Add Variant */}
              <div className="mt-6">
                <p className="mb-3 text-[9px] uppercase tracking-[0.2em] text-black/50">
                  Add New Size
                </p>
                ...
                {variants.length > 0 ? (
                  ...
                  <div className="bg-[#f7f7f7] p-4">
                    ...
                    <p className="mt-2 text-xs leading-5 text-black/50">
                      Add size variants with individual
                      prices and stock.
                    </p>
                  </div>
                )}
            ...
            <section className="bg-white p-6">
              ...
              <div className="mt-6">
                ...
                <p className="mt-2 text-[9px] leading-4 text-black/35">
                  Products are linked using the category
                  slug.
                </p>
              </div>
            </section>
